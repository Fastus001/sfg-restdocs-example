        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-new",
                        requestFields(
                                ...
                                fields.withPaths("version").ignored(),
                                fields.withPaths("createdDate").ignored(),
                                fields.withPaths("lastModifiedDate").ignored(),
                                fields.withPaths("beerName").description("Name of the Beer"),
                                fields.withPaths("beerStyle").description("Style of Beer"),
                                fields.withPaths("upc").description("Beer UPC").attributes(),
                                fields.withPaths("price").description("Beer Price"),
                                fields.withPaths("quantityOnHand").ignored()
                                )));
    }
